...
const perguntasSincronia = [ "Qual é a memória mais vívida que você tem de nós dois no início?", "Se pudéssemos projetar nossa casa ideal hoje, qual detalhe não poderia faltar?", "O que eu faço que, sem eu saber, faz você se sentir mais amada?", "Qual característica minha você acha que mais combina com a sua?", "Qual foi o momento em que você sentiu mais orgulho de nós como um time?", "Se pudéssemos viajar para qualquer lugar do mundo amanhã, para onde iríamos?" ];
