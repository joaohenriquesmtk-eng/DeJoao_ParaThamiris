...
const bancoPerguntasSincronia = [
    ...
    "Qual o nosso ritmo musical oficial quando estamos juntos?",
    ...
    "Qual é a nossa comida oficial de final de semana (Pizza, Hambúrguer, Sushi...)?",
    ...
    "Qual é a bebida que sempre acompanha nossas conversas profundas?",
    "Domingo perfeito: Série no sofá ou Passeio ao ar livre?",
    "Em um jogo do Mengão, a gente comemora com Cerveja ou Refrigerante?",
    "Na hora de decidir o roteiro, vence o Engenheiro ou a Advogada?",
    ...
    "Na hora de dividir a sobremesa, quem acaba comendo a maior parte?",
    "Qual matéria é mais complexa: Cálculos de Engenharia ou Leis do Vade Mecum?",
    "Qual é a rede social que mais usamos para trocar vídeos e memes (Insta, TikTok, Twitter)?",
